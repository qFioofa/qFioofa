...
Сервис автоматического сбора и анализа данных о погоде по 30 городам России.
...
Сервис учёта подписок и регулярных платежей: рассчитывает даты списаний и отслеживает их статусы.
...
**Владею:** Java, ООП, базы данных, SQL, PostgreSQL, REST API, Spring Boot, Spring Data JPA, Hibernate, unit-тесты (JUnit 5, Mockito), Gradle, Maven, Flyway (миграции), Docker, Docker Compose, Linux, Git, CI/CD, Nginx, Python, TCP/IP, Bash.
