...
| Terminal session manager | ![tmux](https://go-skill-icons.vercel.app/api/icons?i=tmux)       | [tmux](https://github.com/tmux/tmux)                        | [Config](https://github.com/qFioofa/qFioofa-tmx)     |
...
| Category                 | Icon                                                              | Name                                                        | Config Link                                          |
| ------------------------ | ----------------------------------------------------------------- | ----------------------------------------------------------- | ---------------------------------------------------- |
| Terminal | ![Wezterm](https://go-skill-icons.vercel.app/api/icons?i=wezterm) | [Wezterm](https://wezterm.org/) | [Config](https://github.com/qFioofa/qFioofa-wezterm) |
| Shell Windows | ![PowerShell](https://go-skill-icons.vercel.app/api/icons?i=powershell) | [PowerShell](https://github.com/powershell/powershell) | [Config](https://github.com/qFioofa/qFioofa-PowerShell) |
